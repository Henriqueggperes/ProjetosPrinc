...
// let listadej = [];
// let maior = 0;
// //numrod = +prompt('Quantas rodadas o jogo terá?: ')
// function maior(maior,comparativo){
//     if(maior<comparativo){
//         maior = comparativo;
//     }
//     return maior;
// }

// numerodej = +prompt('Quantos jogadores irão jogar?: ');

// for(let i = 0;i<numerodej;i++){
//     listadej.push({nome:prompt('Digite seu nome: ')})

// }

// for(let i = 0;i<numerodej;i++){
//     numale = Math.ceil(Math.random()*6);
//     listadej[i].numerodado = numale
// }

// for(let i =0; i<listadej.length;i++){
//     if(listadej[i].numerodado > maior){
//         maior = listadej[i].numerodado
//     }
// }
// for(let i =0; i<listadej.length;i++){
//     if(listadej[i].numerodado == maior){
//         console.log(`O jogador vencedor desta rodada é ${listadej[i].nome} com o numero tirado ${listadej[i].numerodado}.` );
//         listadej[i].rodadas ++;
//     }
// }
